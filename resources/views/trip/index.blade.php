  ...
  <table class="table" style="margin-top:30px;">
    ...
    <tbody>
      ...
      <tr>
        ...
        @if(Auth::user()->hasRole('admin'))
        <td style="text-align: center; vertical-align : middle;">
          <button type="button" class="commenticon" data-target="#archiveTrip" data-toggle="modal" data-trip="{{$trip->id}}" data-title="{{$trip->title}}" data-commentary="{{$trip->commentary}}">
            <i class="fas fa-archive indexicon"></i>
