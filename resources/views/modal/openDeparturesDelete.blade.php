...
<!--    MODAL  -->
<div class="modal fade" id="openDeparturesDelete" tabindex="-1" role="dialog" aria-labelledby="ModalDeleteTrip" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('deletedeparture')}}" >
              ...
              <button type="submit" class="btn btn-sm btn-danger">{{__('Clear Departure')}}</button>
