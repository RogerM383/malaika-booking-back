...
<div id="detachRoomModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      @if(!empty($client))
      <form action="{{route('detachclient', ['client' => $client, 'departure' => $departure->id ]) }}">
                    <div class="form-group">
                        ...
                        <p>{{__('Add the reason for removing the traveler')}}
                    ...
                    <button type="submit" class="btn btn-sm btn-info ">{{__('Remove traveler')}}</button>
