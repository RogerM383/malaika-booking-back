<!--    MODAL  -->
<div class="modal fade" id="deleteClientShow" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <form action="{{route('deleteclient')}}" >
               <div class="form-group">
                  ...
                  <input type="hidden" class="modalText" id="client" name="client">
